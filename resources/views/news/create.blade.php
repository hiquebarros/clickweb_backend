...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-[#613ed9] to-[#4c2db8] px-6 py-5">
        <h2 class="text-white text-xl font-bold flex items-center space-x-2">
            ...
            <span>Cadastrar Nova Notícia</span>
        </h2>
    </div>
    ...
    <form action="{{ route('news.store') }}" method="POST" class="p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0 pt-6 border-t border-gray-200">
            <a href="{{ route('news.index') }}" class="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-semibold">
